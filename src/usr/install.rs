...
pub fn copy_files(verbose: bool) {
    ...
    copy_file("/bin/shutdown", include_bytes!("../../dsk/bin/shutdown"), verbose);
    ...
    copy_file("/var/www/sspos.png", include_bytes!("../../www/sspos.png"), verbose);
}

pub fn main(args: &[&str]) -> Result<(), ExitCode> {
    let csi_color = Style::color("Yellow");
    let csi_reset = Style::reset();
    println!("{}Welcome to sspos v{} installation program!{}", csi_color, env!("CARGO_PKG_VERSION"), csi_reset);
    println!();
